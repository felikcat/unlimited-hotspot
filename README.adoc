...
https://github.com/bol-van/zapret/blob/master/docs/readme.en.md[zapret] is available but challenging to use on Apple silicon macOS (use its https://github.com/bol-van/zapret/blob/master/docs/bsd.eng.md[BSD instructions]).

...
image:ios_network_selection.png[width=320,height=200]
...
Tip me if you want more telecoms tested, such as AT&T, Verizon, and third-party MVNOs using say AT&T's network like Cricket Wireless. As of Sep 10 2023: I've only tested with a Magenta T-Mobile plan, with me maxing out its hotspot data out.

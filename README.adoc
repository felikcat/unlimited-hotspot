...
NOTE: iOS and iPadOS are TODO; I am currently trying out some ideas I have to successfully pull it off, and all without jailbreaking. +
...
. On the hotspot/tethering device, install  https://apkpure.com/netmonster/cz.mroczis.netmonster[NetMonster] for its network monitoring. Without NetMonster, you are blind to what bands are used, and their signal strength.
...
. Open the Terminal, and run: `brew install wireguard-tools`
. 
...
* Linux: https://github.com/bol-van/zapret/blob/master/docs/readme.eng.md[zapret].
